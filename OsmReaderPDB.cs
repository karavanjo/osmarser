...
namespace Osm
{
    ...
    public class OsmReaderPDB
    {
        ...
        /// <summary>
        /// Starts importing data from a file. pdb to the database
        /// </summary>
        /// <param name="pathFileConfig">The path to the file XML import configuration</param>
        public void Read(string pathFileConfig)
        {
